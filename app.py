...
st.markdown(
    """
    **📊 Excel dosyanızı yükleyin →** *projected stock* ve *consensus demand* (EIP) değerlerine göre  
    otomatik **Days of Coverage (DOC)** hesaplamalarını görün.  
    Çıktıyı tablo olarak inceleyebilir veya Excel'e indirebilirsiniz.
    """
)
...
if not month_cols:
    st.error("Ay kolonları bulunamadı. Başlıklar 'YYYY-MM-DD ...' ile başlamalı.")
    st.stop()
